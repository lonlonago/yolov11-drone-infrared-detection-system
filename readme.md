# YOLOv11 Drone Infrared Detection System

## Body

The YOLOv11 drone infrared detection system is based on deep learning YOLOv11. The system includes pedestrian and vehicle detection (YOLOv11+YOLO dataset + UI interface + login registration interface + Python project source code + model).

Classification: 4-class,
Names: ['Car', 'Don't Care', 'OtherVehicle', 'Person'],
Number of datasets: Training set 10128, Validation set 715, Test set 355.
